  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '13px', color: 'rgba(26,26,26,0.55)', margin: '0 0 20px' }}>
        Sobrescreve os textos em PT e EN. Deixe igual ao original pra manter o padrão do código.
      </p>
      ...
      <input
        ...
        style={{ width: '100%', maxWidth: '360px', padding: '10px 12px', borderRadius: '8px', border: '1px solid var(--color-border)', fontSize: '13px', marginBottom: '20px' }}
      />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
        {groups.map(([group, groupItems]) => (
          <details key={group} style={{ background: '#fff', border: '1px solid var(--color-border)', borderRadius: '12px', overflow: 'hidden' }}>
            <summary style={{ padding: '14px 16px', cursor: 'pointer', fontWeight: 700, fontSize: '13px', color: '#1a1a1a', display: 'flex', justifyContent: 'space-between' }}>
              <span>{group}</span>
